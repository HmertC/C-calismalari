...
namespace quizex
{
    ...
    class Program
    {
        ...
        {
            var q1 = new Question("En iyi progralama dili hangisidir?", new string[] { "C#", "Python", "Java", "C++" },"C#");
            var q2 = new Question("En popüler progralama dili hangisidir?", new string[] { "C#", "Python", "Java", "C++" }, "C#");
            var q3 = new Question("En çok kazandıran progralama dili hangisidir?", new string[] { "C#", "Python", "Java", "C++" }, "C#");
